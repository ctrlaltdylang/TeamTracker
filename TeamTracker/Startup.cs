...
namespace TeamTracker
{
    public class Startup
    {
        ...
        {
            // Tell Entity Framework to create and connect to an InMemoryDatabase
            services.AddDbContext<TeamTrackerContext>(options => options.UseInMemoryDatabase(databaseName: "TeamTracker"));
